...
import { scoreFundamentalBoxesWeek } from "@/server/services/fundamental/fundamental-box-scoring.service";
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const scoring =
      ingest.snapshotsWritten > 0 ? await scoreFundamentalBoxesWeek({ snapshotDate: ingest.snapshotDate }) : null;
